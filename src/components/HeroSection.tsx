export default function HeroSection() {
  // Shinta perpendek linknya agar lebih stabil dibaca robot Google
    ...
    <div className="mb-8">
      <div className="relative overflow-hidden rounded-3xl">
        ...
        <img
          ...
          loading="lazy"
          onError={(e) => {
            // Jika gambar utama error, akan otomatis ganti ke gambar cadangan yang stabil
            e.currentTarget.src = "https://images.pexels.com/photos/3183197/pexels-photo-3183197.jpeg";
          }}
        />

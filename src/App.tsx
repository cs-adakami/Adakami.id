        ...
        <div className="max-w-6xl mx-auto px-5 py-8">
          <div className="mb-6">
            <span className="inline-block text-xs tracking-widest uppercase text-emerald-400 font-semibold mb-3">
              Layanan Pelanggan AdaKami Resmi
            </span>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">
              Pusat Informasi & Bantuan
            </h1>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed max-w-3xl">
              Dapatkan dukungan informasi terpadu dan panduan lengkap layanan pelanggan AdaKami yang tersedia 24 jam untuk kenyamanan Anda.
            </p>
          </div>
